...
const Analytics = () => {
  ...
  const activeProjectId =
    selectedProjectId || selectedProjectParam;

  const displayStats = activeProjectId ? stats : null;

  const statusCounts = (
    displayStats?.tasksByStatus || []
  ).reduce((acc, item) => {
  ...
  const sprintProgress = displayStats?.sprintStats?.length
    ? Math.round(
        displayStats.sprintStats.reduce(
          (sum, sprint) =>
            sum + sprint.completionRate,
          0
  ...
  const contributionStats =
    displayStats?.contributionStats || [];
      ...
      <div className="p-6 lg:p-8 space-y-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-slate-600">
            Understand delivery pace, workload mix,
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          {projects.length === 0 && (
            <p className="mt-3 text-xs text-slate-500">
              No projects found. Create a project to view analytics.
            </p>
          )}
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Where work is sitting right now.
                  </p>
                </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Balance critical and routine work.
                  </p>
                </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Track task ownership and completion across project members.
                </p>
              </div>
            ...
            <div className="mt-6 space-y-5">
              ...
              {contributionStats.length === 0 ? (
                <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-4 text-sm text-slate-500">
                  No contribution data available for this project yet.
                </div>
              ) : (
                contributionStats.map((member) => (
